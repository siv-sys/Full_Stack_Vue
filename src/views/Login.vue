    ...
    <div class="auth-card">
      ...
      <form @submit.prevent="handleLogin">
        ...
        <div class="fg">
          ...
          <div class="pw-wrap">
            <input id="password" v-model="password" :type="showPw ? 'text' : 'password'" placeholder="Enter your password" required autocomplete="current-password" :class="{ 'has-error': errors.password }" />
        ...
        <button type="submit" class="btn-submit" :disabled="loading || !emailValid">
